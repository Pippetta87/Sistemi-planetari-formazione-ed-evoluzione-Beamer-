...
\part{Formazione sistemi planetari}\linkdest{planetaryformation}
\input{formation}

\part{Evoluzione dei sistemi planetari: forze gravitazionali e non, collisioni.}\linkdest{evolution}
\input{dynamics}
\input{collisions}
