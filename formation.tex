...
\begin{columns}[T]\begin{column}{0.5\textwidth}
\begin{align*}
&\TDtwoy{t}{\vec{x}_i}=-GM_*\frac{\vec{x}_i}{|x_i^3|}+\sum_{i\neq j}Gm_j\frac{\vec{x}_i-\vec{x}_j}{|\vec{x}_i-\vec{x}_j|^3}+\vec{F}_{gas}+\vec{F}_{col}\\
&t_{rel}=\frac{\sigma^2}{\TDy{t}{\sigma^2}}\approx\frac{1}{n\pir_g^2\sigma\ln{\Lambda}}\\
&=\frac{\sigma^3}{n\piG^2m^2\ln{\Lambda}}
\end{align*}
\end{column}\begin{column}{0.5\textwidth}
