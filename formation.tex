...
\begin{frame}{Viscous stirring, dynamical friction and orbital repulsion}
\begin{block}{Dispersion vs shear dominated encounters}
Characteritic velocity at $r_h=(\frac{m}{3M_*})\expy{1/3}a$ is $v_h=\sqrt{\frac{Gm}{r_h}}$: $\sigma>v_h$ dispersion-dominated 2 body dynamics, $\sigma<v_hshear dominated dynamics where 3-body effects are important$
\end{block}
